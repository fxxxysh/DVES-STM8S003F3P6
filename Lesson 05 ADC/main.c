...
void ADC_Configuration(void);                                                   // Ham cau hinh cho ADC
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void main(void)
{
 ...
 // TIMER1_Configuration();
  ...
  while (1)
  {
 //  TIM1_OC4Init(TIM1_OCMODE_PWM2,TIM1_OUTPUTSTATE_ENABLE,ADC_Value,TIM1_OCPOLARITY_LOW,TIM1_OCIDLESTATE_SET);
...
void GPIO_Configuration(void)
{
  ...
  GPIO_Init(GPIOA,GPIO_PIN_3, GPIO_MODE_IN_FL_NO_IT); 	                        // cau hinh chan PA3 la chan Analog, de noi, khong ngat
  GPIO_Init(GPIOA,GPIO_PIN_2, GPIO_MODE_IN_FL_NO_IT); 	                        // cau hinh chan PA3 la chan Analog, de noi, khong ngat
  GPIO_Init(GPIOA,GPIO_PIN_1, GPIO_MODE_IN_FL_NO_IT); 	                        // cau hinh chan PA3 la chan Analog, de noi, khong ngat
}
...
{
   /*  Init GPIO for ADC2 */
 // GPIO_Init(GPIOA, GPIO_PIN_3, GPIO_MODE_IN_FL_NO_IT);                        // Da cau hinh tren Ham GPIO
  
  /* De-Init ADC peripheral*/
  ADC1_DeInit();

  /* Init ADC2 peripheral */
  ADC1_Init(ADC1_CONVERSIONMODE_CONTINUOUS,                                     // Che do chuyen doi lien tuc voi tan so lay mau dua vao HSI
            ADC1_CHANNEL_0,                                                     // kenh chuyen doi
            ADC1_PRESSEL_FCPU_D18,                                              // Tan So lay mau cua ADC fcpu/18
            ADC1_EXTTRIG_TIM,DISABLE,                                           // Nguon Ngat ngoai cua ADC, khong su dung
            ADC1_ALIGN_RIGHT,                                                   // Data chuyen het ve ben Phai
            ADC1_SCHMITTTRIG_CHANNEL0,DISABLE);                                 // Khong su dung

  /* Enable EOC interrupt */
    ADC1_ITConfig(ADC1_IT_EOCIE,ENABLE);                                               // Ham cho phep ngat ADC1 voi ngat , 
//  ADC1_ITConfig(ADC1_IT_AWS0,ENABLE);
//  ADC1_ITConfig(ADC1_IT_AWS1,ENABLE);
//  ADC1_ITConfig(ADC1_IT_AWS2,ENABLE);      
//  ADC1_ITConfig(ADC1_IT_AWDIE,ENABLE);
 
 /*Start Conversion */
  ADC1_StartConversion();                                                       // Cho phep bat dau qua trinh chuyen doi ADC1        
}
