...
/**
 ...
 {
   if(TIM2_GetITStatus(TIM2_IT_UPDATE)==1)                                      //kiem tra xem co ngat UPDATE da bat hay chua, vi ham ngat nay ap dung cho ngat UPDATE, OVE, BRAK
   {
    GPIO_WriteReverse(GPIOD, GPIO_PIN_2);                                       // Dao trang thai chan D2                        
    GPIO_WriteReverse(GPIOD, GPIO_PIN_3);                                       // Dao trang thai chan D3
    TIM2_ClearITPendingBit(TIM2_IT_UPDATE);                                     // Xoa co ngat UPDATE
   }
...
/**
 ...
 {
   ADC1_Value = ADC1_GetConversionValue();                                      //Lay gia tri ADC dua ve bien ADC_Value                             
   ADC1_ClearITPendingBit(ADC1_IT_EOCIE);                                       //Xoa co ngat ADC
 
   ADC1_ClearITPendingBit(ADC1_IT_AWS0);
   ADC1_ClearITPendingBit(ADC1_IT_AWS1);
   ADC1_ClearITPendingBit(ADC1_IT_AWS2);
   ADC1_ClearITPendingBit(ADC1_IT_AWDIE);
